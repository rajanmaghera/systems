{
  conf.mod.home =
    ...
    in
    {
      options.my.dev-env.enable = mkFBoolOpt "Install development packages on my machine";
      options.my.dev-env.defaultIdentity = mkTBoolOpt "Enable my default DCS email for git";
